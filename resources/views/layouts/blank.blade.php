...
<head>
    ...
    <link href="{{ asset('admin//css/dropify.css') }}" rel="stylesheet">
...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
                ...
                {{-- <img class="img-profile rounded-circle" src="{{ asset($setting->logo) }}"> --}}
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="{{ route('dashboard.categories.index') }}">index</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <div id="collapseOrders" class="collapse" aria-labelledby="headingOrders"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="orders-color.html">Orders</a>
                        <a class="collapse-item" href="orders-border.html">transactions</a>
                    </div>
                </div>
            </li>

            <!-- Nav Item - Coupons Collapse Menu -->
            <li class="nav-item">
                ...
                <div id="collapseCoupons" class="collapse" aria-labelledby="headingCoupons"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="utilities-color.html">Coupons</a>
            ...
            <li class="nav-item">
                ...
                <div id="collapseMembers" class="collapse" aria-labelledby="headingMembers"
                    data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Custom site members:</h6>
                        <a class="collapse-item" href="utilities-color.html">Admins</a>
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                ...
                                <img class="img-profile rounded-circle" src="{{ asset($setting->favicon) }}">
                            </a>
    ...
    <script src="{{ asset('assets/plugins/notify/js/notifit-custom.js') }}"></script><!--Internal  Datepicker js -->
