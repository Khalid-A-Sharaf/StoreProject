                                    ...
                                    <div class="form">
                                        ...
                                        {{-- @if ($category->child_count < 1) --}}
                                            <div class="form-group">
                                                ...
                                                <select name="parent_id" id="" class="form-control">
                                                    <option value="">قسم رئيسي
                                                        {{-- @if ($category->parent_id == null || $category->parent_id == 0) قسم رئيسي @else {{ $category->name }} @endif --}}
                                                    </option>
                                        ...
                                        <div class="form-group mb-0">
                                            ...
                                            <input class="form-control dropify" id="validationCustom02" type="file"
                                                name="image" data-default-file="{{ Storage::url('images/' . $category->image) }}">
                                        </div>
